...
public class PlaceSearchDialog extends AppCompatDialog
    ...
    private void buildDialog() {
        ...
        okTV.setText(!TextUtils.isEmpty(builder.positiveText)
                ? builder.positiveText : "확인");
        cancelTV.setText(!TextUtils.isEmpty(builder.negativeText)
                ? builder.negativeText : "취소");
        locationET.setHint(!TextUtils.isEmpty(builder.hintText) ?
                builder.hintText : "위치를 입력해주세요");

        okTV.setTextColor(builder.positiveTextColor != 0
                ? context.getColor(builder.positiveTextColor)
                : context.getColor(R.color.mt_red));

        cancelTV.setTextColor(builder.negativeTextColor != 0
                ? context.getColor(builder.negativeTextColor)
                : context.getColor(R.color.mt_gray4));

        locationET.setHintTextColor((builder.hintTextColor != 0)
                ? context.getColor(builder.hintTextColor)
                : context.getColor(R.color.mt_gray3));
        ...
        if (builder.headerImageResource != 0) {
            ...
            headerImageIV.setImageResource(R.drawable.bg);
        }
